...
export default function DailySession() {
  ...
  return (
    <div>
      {/* ========== HERO SECTION ========== */}
      <section className="-mx-8 bg-neutral-50 py-6 lg:py-24">
        <div className="max-w-7xl mx-auto px-3 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-16 items-center">
            {/* LEFT: Headline, Subheadline, CTA */}
            <div className="lg:col-span-6">
              <h1 className="text-2xl lg:text-6xl font-semibold text-neutral-900 mb-2 lg:mb-6 leading-tight tracking-tight">
                Instant fluency corrections while you speak.
              </h1>
              <p className="text-sm lg:text-2xl text-neutral-600 mb-4 lg:mb-12 leading-relaxed">
                Real-time analysis based on 47 linguistic error types.
              </p>
              <button
                onClick={() => router.push("/assessment")}
                className="w-full lg:w-auto px-4 lg:px-8 py-2 lg:py-4 bg-neutral-900 text-white text-sm lg:text-lg font-medium hover:bg-neutral-800 transition-colors"
              >
            ...
            <div className="lg:col-span-6">
              <figure className="bg-white border border-neutral-200 p-3 lg:p-8">
                {/* Demo: Grammar Correction Engine */}
                <div className="space-y-2 lg:space-y-6">
                  <div className="border-b border-neutral-200 pb-2 lg:pb-4">
                    <div className="text-[10px] lg:text-xs font-mono text-neutral-500 mb-1 lg:mb-2">INPUT</div>
                    <div className="text-xs lg:text-lg text-neutral-900 font-mono break-words">
                      I <span className="bg-red-100 text-red-700 px-1">go</span> to store yesterday
                    </div>
                  </div>

                  <div className="border-b border-neutral-200 pb-2 lg:pb-4">
                    <div className="text-[10px] lg:text-xs font-mono text-neutral-500 mb-1 lg:mb-2">OUTPUT</div>
                    <div className="text-xs lg:text-lg text-neutral-900 font-mono break-words">
                  ...
                  <div className="space-y-1 lg:space-y-3">
                    <div className="text-[10px] lg:text-xs font-mono text-neutral-500 mb-1 lg:mb-2">ANALYSIS</div>
                    <div className="flex items-start gap-2">
                      <div className="w-1 h-1 rounded-full bg-neutral-400 mt-1" />
                      <div className="text-[10px] lg:text-sm text-neutral-700">
                  ...
                  <div className="pt-2 lg:pt-4 border-t border-neutral-200 flex items-center justify-between text-[10px] lg:text-xs font-mono text-neutral-500">
      ...
      <div className="bg-neutral-900 text-white py-8 lg:py-32 -mx-8 px-3 lg:px-8 mb-10 lg:mb-40">
        <div className="max-w-5xl mx-auto">
          <div className="mb-6 lg:mb-16">
            <div className="text-[10px] lg:text-sm font-mono text-electric-400 mb-2 lg:mb-4 tracking-wider">[ PLATFORM ARCHITECTURE ]</div>
            <h2 className="text-2xl lg:text-6xl font-serif mb-4 lg:mb-12">The Linguistic Engine</h2>
          </div>

          <div className="space-y-6 lg:space-y-16">
            {/* 01 - Morpho-Syntactic Analysis */}
            <div className="flex gap-3 lg:gap-12">
              <span className="font-mono text-lg lg:text-4xl text-electric-400 tracking-wider flex-shrink-0">01</span>
              <div className="min-w-0">
                <h3 className="text-base lg:text-3xl font-serif mb-2 lg:mb-4">Morpho-Syntactic Analysis</h3>
                <p className="text-xs lg:text-xl text-neutral-300 mb-3 lg:mb-8 leading-relaxed font-sans">
            ...
            <div className="flex gap-3 lg:gap-12">
              <span className="font-mono text-lg lg:text-4xl text-electric-400 tracking-wider flex-shrink-0">02</span>
              <div className="min-w-0">
                <h3 className="text-base lg:text-3xl font-serif mb-2 lg:mb-4">Phonetic Decomposition</h3>
                <p className="text-xs lg:text-xl text-neutral-300 mb-3 lg:mb-8 leading-relaxed font-sans">
            ...
            <div className="flex gap-3 lg:gap-12">
              <span className="font-mono text-lg lg:text-4xl text-electric-400 tracking-wider flex-shrink-0">03</span>
              <div className="min-w-0">
                <h3 className="text-base lg:text-3xl font-serif mb-2 lg:mb-4">Adaptive Retention Engine</h3>
                <p className="text-xs lg:text-xl text-neutral-300 mb-3 lg:mb-8 leading-relaxed font-sans">
