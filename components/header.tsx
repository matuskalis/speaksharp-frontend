    ...
    <header className="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-xl border-b border-neutral-200">
      <div className="mx-auto max-w-7xl px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link
            href="/"
            className="text-3xl font-display font-bold text-neutral-900 hover:text-electric-600 transition-colors"
          >
            Vorex
          </Link>
          ...
          <div className="flex items-center gap-4">
            {isAuthenticated ? (
              ...
              <>
                ...
                <button
                  onClick={onSignIn}
                  className="px-6 py-3 text-base font-semibold text-white bg-electric-500 rounded-lg hover:bg-electric-600 transition-colors"
                >
                  Start Free Trial
                </button>
              </>
